$(document).ready(function() {
  ...
  function calculate () {
    ...
    var num1Calculated = parseFloat(num1);
    var num2Calculated = parseFloat(num2);
    var op = num1Calculated + operator + num2Calculated;
    var total = eval(op);
  ...
  $opButton.on('click', function() {
    ...
    if (num1.length === 0) {
      ...
      operator = $buttonValue;
      console.log(num1,operator,num2,reset);
    } else if ((operator.length === 1) && (reset === false) && (num2.length > 0)) {
      calculate ();
      operator  = $buttonValue;
      num2 = '';
      console.log(num1,operator,num2,reset);
